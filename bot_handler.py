...
🔓 Этот проект — <b>Open Source</b>! Мы не храним твои данные в секрете от тебя. Весь исходный код открыт и доступен для аудита.

Если ты разработчик и хочешь помочь или проверить код, загляни в наш <a href='https://github.com/Kebiproger/platonusgram'>GitHub</a>.
