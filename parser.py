...
async def get_platonus_grades(login, password, session_cookies) -> tuple[str, dict]:
    """
    Парсит оценки.
        ...
        try:
            ...
            if "AccessDenied" in str(resp.url):
                ...
                login_resp = await client.post(
                    login_url, json={"login": login, "password": password}
                )
            ...
            return result_text, current_cookies
